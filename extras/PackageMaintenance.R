...
OhdsiRTools::checkUsagePackage("PMSstudy")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PMSstudy.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PMSstudy.pdf")
...
OhdsiRTools::createRenvLockFile("PMSstudy")
